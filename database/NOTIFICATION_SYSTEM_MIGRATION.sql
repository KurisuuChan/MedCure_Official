...
-- Critical fixes for notification deduplication and health check scheduling
-- Date: October 7, 2025
-- ============================================================================
...
-- First, drop any existing versions of this function
DROP FUNCTION IF EXISTS should_run_health_check(TEXT, INTEGER);
DROP FUNCTION IF EXISTS should_run_health_check(TEXT);
DROP FUNCTION IF EXISTS should_run_health_check();
...
-- First, drop any existing versions of this function
DROP FUNCTION IF EXISTS record_health_check_run(TEXT, INTEGER, TEXT);
DROP FUNCTION IF EXISTS record_health_check_run(TEXT, INTEGER);
DROP FUNCTION IF EXISTS record_health_check_run(TEXT);
DROP FUNCTION IF EXISTS record_health_check_run();
...
-- ============================================================================
-- STEP 5: Enhance cleanup_old_notifications function (if not exists)
-- ============================================================================
