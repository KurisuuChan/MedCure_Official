...
const medName = (sampleProduct.brand_name && sampleProduct.brand_name.trim()) 
  ? sampleProduct.brand_name 
  : (sampleProduct.generic_name && sampleProduct.generic_name.trim()) 
    ? sampleProduct.generic_name 
    : "Unknown Medication";

const manufacturer = (sampleProduct.manufacturer && sampleProduct.manufacturer.trim()) 
  ? sampleProduct.manufacturer 
  : "Not Specified";

const dosage = (sampleProduct.dosage_strength && sampleProduct.dosage_strength.trim()) 
...
console.log("If your PDF shows 'N/A' values, it means these fields are empty in your database");